...
export const PlaylistScreen: React.FC<PlaylistScreenProps> = () => {
  const videoRef = useRef(null).current;
  ...
  return (
    <View style={styles.container}>
      <View style={styles.video2}>
        <Text style={styles.txt_video}>id: {currentVideo.id}</Text>

        <Text style={styles.txt_video}>title: {currentVideo.title}</Text>

        <Text style={styles.txt_video}>subtitle: {currentVideo.subtitle}</Text>
      </View>
      ...
      <View style={styles.buttons}>
        ...
        <Button
          ...
          onPress={() =>
            status.isPlaying ? videoRef.pauseAsync() : videoRef.playAsync()
          }
        />
        <Button
          title={"Proxima"}
